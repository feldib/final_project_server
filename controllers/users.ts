...
export async function messageToAdministratorController(req: Request, res: Response) {
...
export async function getShoppingCartController(req: Request, res: Response) {
  const artworks = await getShoppingListItems(req.id!);
  res.json(artworks);
}


export async function addToShoppingCartController(req: Request, res: Response) {
...
export async function updateShoppingCartController(req: Request, res: Response) {
...
export async function deleteFromShoppingCartController(req: Request, res: Response) {
...
export async function checkIfWishlistedController(req: Request, res: Response) {
  const artwork_id = parseInt(req.params.artwork_id);
...
export async function addToWishlistedController(req: Request, res: Response) {
  const artwork_id = req.body.artwork_id;
...
export async function removeFromWishlistedController(req: Request, res: Response) {
  const artwork_id = parseInt(req.params.artwork_id);
...
export async function updateUserDataController(req: Request, res: Response) {
  await updateUserData(req.id!, req.body.field_name, req.body.value);
  res.end();
}

export async function registerUserController(req: Request<object, StandardResponse, RegisterRequest>, res: Response<StandardResponse>) {
...
export async function makeOrderController(req: Request, res: Response) {
...
export async function getReviewsOfUserController(req: Request, res: Response) {
