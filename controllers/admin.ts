...
export function authenticateAdminController(_: Request, res: Response) {
...
export const addNewArtworkUpload = multer({ storage: multer.memoryStorage() });

export async function postImagesController(req: Request, res: Response) {
...
export async function putImagesController(req: Request, res: Response) {
  const artwork_id = req.params.id;
...
export async function deleteImagesController(req: Request, res: Response) {
...
export async function getReviewsController(_: Request, res: Response) {
  const reviews = await getUnapprovedReviews();
  res.json(reviews);
}

export async function putReviewsController(req: Request, res: Response) {
  const id = parseInt(req.params.id);
  await approveReview(id);
  res.end();
}

export async function deleteReviewsController(req: Request, res: Response) {
  const id = parseInt(req.params.id);
...
export async function getOrdersController(_: Request, res: Response) {
  const orders = await getOrders();
  res.json(orders);
}


export async function getUnansweredMessagesController(_: Request, res: Response) {
  const messages = await getUnansweredMessages();
  res.json(messages);
}


export async function postReplyToMessageController(req: Request, res: Response) {
  const { message_id, email, reply_title, reply_text } = req.body;
  await sendReplyToMessage(message_id, email, reply_title, reply_text);
  res.end();
}

export async function getRegisteredUsersController(_: Request, res: Response) {
  const users = await getRegisteredUsers();
  res.json(users);
}

export async function getOrdersOfUserController(req: Request, res: Response) {
...
export async function getFeaturedController(req: Request, res: Response) {
...
export async function postFeaturedController(req: Request, res: Response) {
...
export async function deleteFeaturedController(req: Request, res: Response) {
  const artwork_id = parseInt(req.params.id);
...
export async function postArtworkController(req: Request, res: Response) {
  try {
